...
# these methods are used for training the model
...
def run_style_transfer(img):
    ...
    content_path = img.imageFile
    style_path = os.path.join(BASE_DIR, 'media', 'static', 'style_transfer', 'StarryNight.jpg')

    print("Running 1 iterations.")
    best, best_loss = style_transfer(content_path, style_path, num_iterations=1)
    print("Iterations complete.")

    # image result from tensorflow model
    generatedImage = PIL.Image.fromarray(best)
